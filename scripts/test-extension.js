...
(async () => {
  ...
  try {
    ...
    // Force the extension to use the 'simple' inpaint model so it doesn't try to download LaMa
    console.log('[Puppeteer] Forcing extension to use Simple inpaint tier...');
